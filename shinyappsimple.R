        ...
        mainPanel(
          ...
          fluidRow(
            column(
              12,
              div(
                style = "width:100%; height:400px; border:1px solid #ccc; display:flex; align-items:center; justify-content:center; background-color:#fafafa;",
          ...
          #CSV browse and controls
          fluidRow(
            column(
              8,
              div(
                style = "height:380px; overflow-y:auto; border:1px solid #ccc; padding:5px; box-sizing:border-box;",
                uiOutput("csv_browse_box")
              )
            ),
            column(
              4,
              selectInput("csv_type", "Select CSV Type to Browse",
                          choices = c("beta_mean","beta_sd","beta_pval","beta_fdr")),
